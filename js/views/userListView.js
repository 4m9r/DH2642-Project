function UserListView(props) {
    return (
        <div>
            <div>
                <p style="margin-bottom: 15px;"><b>Find out what others have been watching!</b></p>
                {/* {props.users.map(x =>
                ...
                <span style="display: block; margin-bottom: 10px">
                    ...
                    <p style="display: inline; margin: 15px;">Amir</p>
                </span>
